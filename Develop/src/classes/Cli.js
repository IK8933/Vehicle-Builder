...
var Cli = /** @class */ (function () {
    ...
    Cli.prototype.createVehicle = function () {
        ...
        inquirer_1.default
            ...
            // add statements to create a truck or motorbike if 
            // the user selects the respective vehicle type
    ...
    Cli.prototype.findVehicleToTow = function (truck) {
        ...
        inquirer_1.default
            ...
            if (!truck) {
                console.log("The truck ".concat(vehicleToTow, " cannot tow iteself"));
                _this.performActions();
            }
